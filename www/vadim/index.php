...
<head>
  ...
  <script type='text/javascript' src='strophe.chatstates.js'></script>
...
<div>
    ...
    <div id='login_dialog' class='hidden'>
        <label>Chat Room (fill text and create a new room) empty - enter predefined room:</label><input type='text' id='room'>
